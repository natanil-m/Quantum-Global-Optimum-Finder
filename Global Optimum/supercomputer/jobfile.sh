...
#SBATCH --account=bbor-delta-gpu #msoltaninia
#SBATCH --job-name=myjobtest
#SBATCH --time=06:00:00      # hh:mm:ss for the job
##SBATCH --output="/u/msoltaninia/GF/outputs/"
...
#conda install conda-forge/label/broken::cuquantum-python

#pip uninstall cuquantum-python-cu11
